...
void sortDescByPopulation(country countries[], int count);
float average(country countries[], int count);
...
int main(int argc, char *argv[])
{
    ...
    sortDescByPopulation(countries, count);
